...
$answer5 = func_assort($sub1,$sub2,$sub3);
...
function func_assort($sub1,$sub2,$sub3){
    
    $str2 = strip_tags($sub1);
    
    //★注意　array_pushの返り値は追加後の要素数
    array_push($sub2,"+LENOVO+");

    $arr3 = array_merge($sub2,$sub3);
